############################################################
#!/bin/bash
# (c) Carsten Rieger IT-Services (Ubuntu 18.04.x LTS 64BIT)
# Nextcloud 18
# v.200421: Changes to MariaDB
############################################################
...
yes | sudo -u www-data php /var/www/nextcloud/occ db:convert-filecache-bigint
echo " "
